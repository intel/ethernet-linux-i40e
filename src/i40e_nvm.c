...
/**
 * get_elapsed_time - Generic request for releasing the NVM ownership
 ...
 **/
static i40e_status i40e_read_nvm_buffer_srctl(struct i40e_hw *hw, u32 offset,
							u16 *words, u16 *data)
{
	i40e_status ret_code = I40E_SUCCESS;
	u32 index;
 ...
 * and followed by the release.
 **/
static i40e_status i40e_read_nvm_buffer_aq(struct i40e_hw *hw, u32 offset,
						     u16 *words, u16 *data)
{
